    ...
    <div class="container form-container p-5 mt-5 mb-5">
        ...
        <form id="register-form" action="{{ route('register') }}" method="POST" novalidate>
            ...
            <div class="mb-3 mt-4">
                ...
                <input type="text" value="{{ old('name') }}" name="name" class="form-control" id="name" autocomplete="on" aria-describedby="personNameHelp" placeholder="John Doe" required>
                <div class="field-error text-danger small mt-1" data-for="name"></div>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="email" value="{{ old('email') }}" name="email" class="form-control" id="email" autocomplete="on" aria-describedby="personEmailHelp" placeholder="you@example.com" required>
                <div class="field-error text-danger small mt-1" data-for="email"></div>
            </div>
            <div class="mb-3">
                <label for="password" class="form-label">Password</label>
                <input type="password" name="password" class="form-control" id="password" autocomplete="on" aria-describedby="personPasswordHelp" placeholder="password123" required>
                <div class="field-error text-danger small mt-1" data-for="password"></div>
            </div>
            <div class="mb-3">
                <label for="password_confirmation" class="form-label">Confirm Password</label>
                <input type="password" name="password_confirmation" class="form-control" id="password_confirmation" autocomplete="on" aria-describedby="personPasswordHelp" placeholder="password123" required>
