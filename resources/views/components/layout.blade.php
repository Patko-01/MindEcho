            ...
            <div class="d-flex align-items-center">
                ...
                @auth
                    <div class="d-inline-flex flex-nowrap align-items-center ms-2">
                        ...
                        <a class="nav-link p-0 d-inline-block" href="{{ route('show.profile.edit', auth()->id()) }}" aria-label="Edit profile">
    ...
    <div class="container">
        <footer class="row row-cols-1 row-cols-md-5 py-5 border-top">
            ...
            <div class="col mb-3"><h5>Contact</h5>
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="mailto:patriksam258@gmail.com" class="nav-link p-0 text-body-secondary">patriksam258@gmail.com</a></li>
                    @auth
