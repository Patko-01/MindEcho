...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ route('home') }}">Mindecho</a>
            @auth
                <span class="me-2">Welcome, {{ auth()->user()->name }}!</span>

                <a class="nav-link" href="{{ route('show.profile.edit') }}">
...
<div class="container">
    <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 border-top">
        ...
        <div class="col mb-3"><h5>Contact</h5>
            <ul class="nav flex-column">
                <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">support@mindecho.ai</a></li>
